"""Benchmark-owned generic rule reader for the R16 resource-order controls."""

from __future__ import annotations

K8S_MODEL_FIXED_R16_POLICY = """
import re
...
def on_turn(turn):
    ...
    if stage == "resource-source-survey":
        ...
        return {"pack_text": "[[doc:reference-source]] source reviewed"}
...
def k8s_model_fixed_r16_policy_text() -> str:
    return K8S_MODEL_FIXED_R16_POLICY


__all__ = ["K8S_MODEL_FIXED_R16_POLICY", "k8s_model_fixed_r16_policy_text"]
