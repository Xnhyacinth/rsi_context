...
from rsicontext.datasets import EncodedWindowTokenizer, load_helmet_kilt_items
...
_DEFAULT_SOURCE = Path("data/helmet-data/data/kilt/popqa_test_1000_k1000_dep6.jsonl")
_SOURCE_ID = "princeton-nlp/HELMET/popqa_test_1000_k1000_dep6.jsonl"
_SOURCE_REVISION = "bc560a6b8165c696ad4bc3d1612c64b5794ba328"
_SOURCE_SHA256 = "ca74dec945e9c837be4d7739da2194fbb09b6f8d5affa9823d979936c63fc89f"
...
def _load_tokenizer(path: Path) -> EncodedWindowTokenizer:
...
def _source_token_summary(items: tuple[EvaluationItem, ...]) -> dict[str, float | int]:
