...
- Hiding policy-worker exceptions as a class name only is rejected: the
  explorer cannot debug a TypeError without the message. Surface a one-line
  `Type: message` diagnostic; do not rewrite the candidate.
